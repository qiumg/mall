                    ...
                    <div class="m-order">
                        ...
                        <div class="orderContentBox">
                            <div class="orderContent">
                                <div class="orderContentpic">
                                    <div class="imgBox">
                                        <a href="orderinfo.html"><img src="../images/zs.jpg"></a>
                                    </div>
                                </div>
                        ...
                        <div class="orderContentBox">
                            <div class="orderContent">
                                <div class="orderContentpic">
                                    <div class="imgBox">
                                        <a href="orderinfo.html"><img src="../images/zs1.jpg"></a>
                                    </div>
                                </div>
                                <div class="detailContent">
                        ...
                        <div class="twoTabModel credit">
                            ...
                            <div class="Box">
                                ...
                                <div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
                                    <ul class="am-slides">
                                        <li><a href="#"><img src="../images/act1.jpg" /></a></li>
                                        <li><a href="#"><img src="../images/act2.jpg" /></a></li>
                                        <li><a href="#"><img src="../images/act3.jpg" /></a></li>
                                        <li><a href="#"><img src="../images/act1.jpg" /></a></li>
                                        <li><a href="#"><img src="../images/act2.jpg" /></a></li>
                                        <li><a href="#"><img src="../images/act3.jpg" /></a></li>
                                    </ul>
                ...
                <div class="new-goods">
                    ...
                    <div class="new-goods-info">
                        <a class="shop-info" href="#">
                            ...
                            <span class="shop-title">高跟鞋</span>
                        </a>
                        <a class="follow">收藏</a>
                    </div>
                </div>
                ...
                <div class="am-tabs-bd">
                    ...
                    <div data-tab-panel-0 class="am-tab-panel am-active">
                        <div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
                            <ul class="am-slides">
                                <li>
                                    <a><img class="am-thumbnail" src="../images/act1.jpg" /></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail" src="../images/act2.jpg" /></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail" src="../images/act3.jpg" /></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail" src="../images/act1.jpg" /></a>
