...
<%--    </div>div--%>
    ...
    %>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="admin_add('添加用户','/add','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span>  </div>
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c">
            ...
            <td class="f-14">
<%--
 <a title="编辑" href="javascript:;" onclick="mmall_user_up('用户编辑','/mm_userUpdate? id=<%= user.getId()%>',<%=user.getId()%>)" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>--%>

    <a title="编辑" href="javascript:;" onclick="mmall_user_up(this,<%=user.getId()%>)" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>

    <a title="删除" href="javascript:;" onclick="mmall_user_del(this,<%=user.getId()%>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
        </tr>
        <%
            }
            }
...
<script type="text/javascript">
    ...
    */
    ...
    /*管理员-删除*/
    function mmall_user_del(obj,id){
